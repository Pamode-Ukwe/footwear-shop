...
const CartContent = () => {
  ...
  return (
    <>
      ...
      <div className="flex gap-12 p-10 justify-center bg-hero-bg/5">
        {/* Shopping Cart */}
        <div onClick={() => lastCheck()} className="cursor-pointer">
        ...
        {/* Checkout Details */}
        <div onClick={() => finalCheck()} className=" cursor-pointer">
        ...
        {/* Order Complete */}
        <div>
          <p className={`${page === 'thirdPage' ? "font-semibold text-sucess-green text-nowrap" : "font-semibold text-main-grey text-nowrap"}`}>
